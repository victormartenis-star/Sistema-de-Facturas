...
const GESTION: NavItem[] = [
  ...
  {
    href: '/auditoria-contratos',
    label: 'Auditoría de contratos',
    icon: IconGavel,
  },
  ...
  { href: '/fichajes', label: 'Fichajes', icon: IconClock },
  { href: '/checklist-prl', label: 'Checklist PRL', icon: IconShield },
  ...
  {
    href: '/contradictorios',
    label: 'Contradictorios y Modificados',
    icon: IconClipboard,
  },
