...
const ENTITY_LABELS: Record<string, string> = {
  ...
  bim_element_link: 'Vínculo BIM',
  bim_model: 'Modelo BIM',
  change_order: 'Contradictorio/modificado',
  comparativo: 'Comparativo',
  comparativo_oferta: 'Oferta de comparativo',
  contract_audit: 'Auditoría de contrato',
  equipo: 'Equipo',
  esg_factor_emision: 'Factor de emisión ESG',
  esg_registro_emision: 'Registro de emisión ESG',
  fichaje: 'Fichaje',
  investment_account: 'Cuenta de inversión',
  investment_cashflow: 'Cashflow de inversión',
  investment_participation: 'Participación',
  investor: 'Inversor',
  iot_alerta: 'Alerta IoT',
  iot_lectura_telemetria: 'Lectura de telemetría',
  mantenimiento_equipo: 'Mantenimiento de equipo',
  parte_maquinaria: 'Parte de maquinaria',
  parte_personal: 'Parte de personal',
  postventa_incident: 'Incidencia de postventa',
  prl_checklist: 'Checklist PRL',
  rcd_vale: 'Vale RCD',
  real_estate_key_handover: 'Entrega de llaves',
  real_estate_reservation: 'Reserva inmobiliaria',
  real_estate_unit: 'Unidad inmobiliaria',
